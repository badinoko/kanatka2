...
- **KAN-079**: Редизайн навбара v3.0 — первый этап (навигация + кнопки + мониторинг) реализован, требуется проверка пользователя.
...
- Начинается цикл v3.0. Тег v2.0 зафиксирован на GitHub.
